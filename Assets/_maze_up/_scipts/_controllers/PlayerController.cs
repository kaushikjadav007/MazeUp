...
public class PlayerController : MonoBehaviour
{
    ...
    [Space]
    public int m_platform_gen_count;
    [Space]
    public bool m_input;
    ...
    private int m_platform_disable_count;
    ...
    void _Jump()
    {
        ...
        m_platform_disable_count++;

        if (m_platform_disable_count == 15)
        {
            //Disable older platform
            m_platform_disable_count = 0;
            m_script_ref.m_event_controller._NotifyOnPlatformDisable();
        }

        if (m_platform_gen_count==10)
        {
